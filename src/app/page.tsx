      ...
      <footer className="bg-white py-20 px-6 border-t border-luxury-cream mt-24">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-12 w-full md:w-auto">
            ...
            <div>
              <h4 className="text-xs uppercase tracking-widest font-bold mb-6 text-luxury-slate">
                Links
              </h4>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="flex gap-2">
                <input
                  type="email"
                  placeholder="Email"
                  className="bg-luxury-cream border-none rounded-xl p-3 text-sm w-full outline-none focus:ring-1 focus:ring-primary"
                />

                <button className="bg-luxury-slate text-white px-4 rounded-xl text-xs font-bold uppercase tracking-tighter">
                  Join
                </button>
              </div>
            </div>
